...
- **3D-просмотр** доски с фаской и маслом, без единой строки JavaScript
...
одномерный: кроится длина, ширина не укладывается. Ошибка направлена
в безопасную сторону — настоящая закупка будет **не меньше** расчётной, —
но метраж на странице закупки надо читать как нижнюю границу, а не как
итог (Р27).
